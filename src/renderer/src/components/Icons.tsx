...
export const SettingsIcon = ({ className }: IconProps) => (
  <svg className={className} viewBox="0 0 24 24" aria-hidden="true">
    ...
    <path d="M14.2 3.8h-4.4l-.34 2.05c-.42.16-.82.37-1.19.62l-1.94-.73-2.2 3.82 1.6 1.3a7.7 7.7 0 0 0 0 2.28l-1.6 1.3 2.2 3.82 1.94-.73c.37.25.77.46 1.19.62l.34 2.05h4.4l.34-2.05c.42-.16.82-.37 1.19-.62l1.94.73 2.2-3.82-1.6-1.3a7.7 7.7 0 0 0 0-2.28l1.6-1.3-2.2-3.82-1.94.73a7.1 7.1 0 0 0-1.19-.62L14.2 3.8Z" />
  </svg>
)
